...
# #rcv1 2999 - 14125
rcv1_bertopic = 90 + 35 #remove duplicate
rcv1_lines = 14125

filename = '../datasets/RCV1_train_texts_50.txt'  # Change this to the path of your text file


documents = load_and_parse_documents(filename, rcv1_lines)
...
# Apply LDA
model = lda.LDA(n_topics=rcv1_bertopic, n_iter=1500, random_state=42)
model.fit(X)
