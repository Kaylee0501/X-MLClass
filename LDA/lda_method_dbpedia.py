...
# #dbpedia 7999 - 26782
dbpedia_bertopic =  161 + 15 #remove duplicate
dbpedia_lines = 26782

filename = '../datasets/DBPedia-298_train_texts_50.txt'  # Change this to the path of your text file


documents = load_and_parse_documents(filename, dbpedia_lines)
...
# Apply LDA
model = lda.LDA(n_topics=dbpedia_bertopic, n_iter=1500, random_state=42)
model.fit(X)
