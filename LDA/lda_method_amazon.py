...
# #amazon 13999 - 31918
amazon_bertopic = 256 + 115 #remove duplicate
amazon_lines = 31918
filename = '../datasets/Amazon-531_train_texts_50.txt'  # Change this to the path of your text file


documents = load_and_parse_documents(filename, amazon_lines)
...
# Apply LDA
model = lda.LDA(n_topics=amazon_bertopic, n_iter=1500, random_state=42)
model.fit(X)
