...
filename = '../datasets/AAPD_train_texts_50.txt'  # Change this to your text file path
aapd_bertopic = 127
aapd_lines = 11033
texts = load_and_parse_documents(filename, aapd_lines)
...
nmf = NMF(
    n_components=aapd_bertopic,  # Number of topics
    init='nndsvd',
    random_state=42
).fit(tfidf)
